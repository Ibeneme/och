      ...
      <section className="py-20 px-6 lg:px-12 max-w-7xl mx-auto space-y-24">
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            {/* Value 01 */}
            <div className="bg-white border border-[#EFE8D8] rounded-3xl p-8 lg:p-9 space-y-5">
              <div className="w-12 h-12 rounded-2xl bg-[#F3ECDC] text-[#C89B3C] font-bold flex items-center justify-center text-sm border border-[#EFE8D8]">
                01
              </div>
